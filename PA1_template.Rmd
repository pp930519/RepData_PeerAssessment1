...
ggplot(dat2, aes(x = as.integer(as.character(interval)), y = steps_ave)) + geom_line(col = "blue") + labs(x = "interval", y = "average number of steps")
```
...
ggplot(dat_new, aes(x = interval, y =  steps_mean, color = weekdays)) + geom_line() + facet_wrap(~ weekdays, ncol = 1, nrow = 2) + labs(y = "Number of steps")
```